...
answer_5() {
	...
	javac project1_2_5.java
        java project1_2_5 $first $second
        #echo ""
}
...
answer_6() {
	...
	#do
		...
		#echo "$movie,"
	#done < q6
        javac project1_2_6.java
        java project1_2_6 q6
}
...
answer_7() {
    ...
    #do
    	...
    	#echo "$os,"
    #done < q7
    javac project1_2_7.java
    java project1_2_7 q7
}
